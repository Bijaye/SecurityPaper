...
/* Get Cookie Domain - CWA - updated 3/19 for redesign
 *
 */
...
function cmCustomLinkClickHandler(link) {
	if (window.location.hostname.indexOf("downloadcenter.trendmicro.com") == -1 && window.location.href.indexOf("cwdev.trendnet.org/downloadcenter") == -1) {
	   ...
	   if (link.href.indexOf(".apk") > -1) {
	   	cmCreatePageviewTag(link.href, "APKDOWNLOAD");
	   }
	}
/* Track EMEA Consumer Trial Downloads as page views and events
 *
 */
	if (link.href.indexOf("/home/trial/index.php") > -1) {
		cmCreatePageviewTag(link.href, "Consumer Trial Download");
		cmCreateConversionEventTag(link.href, "2", "Consumer Trial Download", "100");
	}
}
//-->